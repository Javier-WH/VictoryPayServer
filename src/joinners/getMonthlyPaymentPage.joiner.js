...
const {getMonthlyPaymentListPage} = require("../controllers/monthlyPayment.controller");




async function getMonthlyPage(req, res){
    ...
    try {
        const recordPage = await getMonthlyPaymentListPage(date, page);
