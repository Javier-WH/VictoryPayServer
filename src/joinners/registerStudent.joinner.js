...
const {getStudentByCi, getStudentByCode, insertStudent, updateStudentByCi, updateStudentByCode} = require("../controllers/student.controller");
...
async function registerStudent(req, res){
    ...
    try {
        ...
        if(student != null){
           let conflict = getJsonResponse(data, student.dataValues);
           conflict.CONFLICT = "1";
